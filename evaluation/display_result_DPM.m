function display_result_DPM(seq_name)
...
result_path = '../result/DPM_VOC2007/KITTI';
...
for i = 1:N
    ...
    tit = sprintf('%s: %.2f %.2f %.2f %.2f %.2f', filenames{i}(1:end-4), det(1,5), det(2,5), det(3,5), det(4,5), det(5,5));
    title(tit);
